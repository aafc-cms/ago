...
class Utils {
  ...
  /**
   * Is a variable from a _REQUEST set?
   */
  ...
  /**
   * Does a variable from a _REQUEST exist?
   */
  ...
  /**
   * Retrieve a _COOKIE var (trimmed).
   */
  ...
  /**
   * Generate some protected markup.
   */
