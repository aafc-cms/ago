...
var Special = function() {
  ...
  function init() {
    ...
    $("#edit-field-special-value").change(function() {
      if(this.checked && $("#sp_special_en".length == 0)) {
        CKEDITOR.instances["edit-body-0-value"].setData(newcontent + oldcontent);
      }
      else {
        CKEDITOR.instances["edit-body-0-value"].setData(oldcontent);
      }
      if (this.checked && $("#sp_special_fr".length == 0)){
        CKEDITOR.instances["edit-body-etuf-fr-0-value"].setData(newcontentfr + oldcontentfr);
      }  
      else {
        CKEDITOR.instances["edit-body-etuf-fr-0-value"].setData(oldcontentfr);
      }
    });
