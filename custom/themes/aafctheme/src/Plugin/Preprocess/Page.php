...
class Page extends BootstrapPage {
  ...
  public function preprocess(array &$variables, $hook, array $info) {
    ...
    if ($wxt_active == 'gcweb' || $wxt_active == 'gcweb_legacy' || $wxt_active == 'gcwu_fegc' || $wxt_active == 'gc_intranet') {
      ...
      $gcweb_cdn_footer_canada_ca = $this->theme->getSetting('wxt_gcweb_footer_twig_extension');
      ...
      $variables['gcweb_cdn_footer_canada_ca_enabled'] = (!empty($gcweb_cdn_footer_canada_ca)) ? TRUE : FALSE;
